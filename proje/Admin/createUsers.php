            ...
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post" action="scripts/saveUsers.php">
                   <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">adi<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="adi" id="exampleInputadi" placeholder="First Name">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">soyadi<span class="text-danger ml-2">*</span></label>
                      <input type="textarea" class="form-control" name="soyadi" id="exampleInputadi" placeholder="Last Name">
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                      ...
                      <input type="date" class="form-control" name="dob" id="exampleInputadi" placeholder="Dob">
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Email Address<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="email" id="exampleInputadi" placeholder="Email Address">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">Phone Number<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="phoneNo" id="exampleInputadi" placeholder="Phone Number">
                        </div>
                    </div>
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="city" id="exampleInputadi" placeholder="City">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">State<span class="text-danger ml-2">*</span></label>
                      <input type="textarea" class="form-control" name="state" id="exampleInputadi" placeholder="State">
                        </div>
                    </div>
                   <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Address<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="address" id="exampleInputadi" placeholder="Address">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">LGA<span class="text-danger ml-2">*</span></label>
                            <input type="textarea" class="form-control" name="lga" id="exampleInputadi" placeholder="State">                    
                    </div>
                    </div>  
                      <div class="form-group row mb-3">
                        <div class="col-xl-6">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT roles.roleName,users.adi,users.soyadi,users.gender,users.dob,users.city,users.state,users.lga,users.emailAddress,users.address,users.phoneNo,users.dateCreated
                      FROM users
