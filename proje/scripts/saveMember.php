...
// echo $_POST['isExisting'];
        ...
        else
        {
            ...
            if($_POST['userType'] == 1) // if the userType is staff, save staff info and user info
            {
                ...
                $userqr = "INSERT INTO users (roleId,coopId,adi,soyadi,gender,dob,city,state,lga,emailAddress,address,phoneNo,password,dateCreated) 
                        VALUES ('2','$coopAccountId','$adi','$soyadi','$gender','$dob','$city','$state','$lga','$email','$address','$phoneNo','$password','$dateCreated')";
